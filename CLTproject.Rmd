...
The plot is almost uni modal but not quite, every time we re-due the code plot its going to change a bit. At this point in the plot we know that we are looking at 9 samples thus the "N=9". Interestingly in the beginning we were looking at bi modal distribution's but this is almost uni modal, as we change the code maybe a different appearance may appear.
...
The plot is looking pretty much uni modal. Again every time we re-due the code plot its going to change a bit. At this point in the plot we know that we are looking at 16 samples thus the "N=9". Interestingly in the beginning we were looking at bi modal distribution's because of the samples averaged together.    
...
The plot is looking uni modal. Again every time we re-due the code plot its going to change a bit. At this point in the plot we know that we are looking at 25 samples thus the "N=25". Interestingly in the beginning we were looking at bi modal distribution's because of the samples averaged together so there is no change in these last three plots.
...
The plot is looking uni modal. Again every time we re-due the code plot its going to change a bit but it is looking again like a normal distribution. At this point in the plot we know that we are looking at 36 samples thus the "N=36". Interestingly in the beginning we were looking at bi modal distribution and now can see how they differed with the ending samples n=9, n=16, n=25, and with the sample that is above the 30 sample from the central limit theorem. In the end the 36 samples that is above 30 demonstrates how a normal distribution could look applying the central limit theorem.
